...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference("Fruit.count") do
      post fruits_url, params: { fruit: { color: @fruit.color, name: @fruit.name, origin: @fruit.origin, price: @fruit.price, season: @fruit.season, user_id: @fruit.user_id } }
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { color: @fruit.color, name: @fruit.name, origin: @fruit.origin, price: @fruit.price, season: @fruit.season, user_id: @fruit.user_id } }
